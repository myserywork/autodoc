...
<head>
    ...
    <link href="<?= base_url(); ?>assets/css/style-login.css?v=<?= time(); ?>" rel="stylesheet">
...
<body data-page="header">
    ...
    <div id="wrapper">
        ...
        <div id="main-content">
            <div class="login">
                <div class="login-img">
                    <img src="<?= base_url(); ?>/assets/img/login-side-img.svg" alt="Imagem" class="imagem">
                </div>
                <div class="login-form">
                    <div class="row" style="margin-top: 20%;">
                        <div class="col-md-2"></div>
                        <div class="col-md-10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="163" height="50" viewBox="0 0 104 32" fill="none">
                            ...
                            <div class="form-login">
                                <form id="formLogin" action="<?=base_url();?>auth/login" method="post">
                                    ...
                                    <div class="form-group mt-3 mb-3">
                                        <div class="input-group mb-3" id="show_hide_password">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text" id="basic-addon2"><a href="" style="color:black"><i class="fa fa-eye-slash" aria-hidden="true"></i></a></span>
                                            </div>
                                        </div>
                                    </div>
                                    <small id="error-message" style="display:none;color:#FF1616"></small>
                                    <div class="form-group mt-3 mb-3 text-right">
                                        <small>Esqueceu a Senha?</small>
                                    </div>
                                    <button type="submit" style="width: 100%;" class="btn btn-primary text-submit-btn">Entrar</button>
                                </form>
                            </div>
                        </div>
                    </div>
...
return true;
    ...
    $(document).ready(function() {
        ...
        $('#formLogin').jqxValidator({
            rules: [{
                    input: '#email',
                    message: 'Preencha o campo com um e-mail!',
                    action: 'keyup, blur',
                    rule: function(input) {
                        return input.val() !== '';
                    }
                },
                {
                    ...
                    rule: function(input) {
                        ...
                        var isValidMail = regex.test(input.val());
                        return isValidMail;
                    }
                },
                {
        ...
        $('#formLogin').on('submit', function(e) {
            ...
            // Validate the form
            if ($('#formLogin').jqxValidator('validate')) {
                // Get the form data
                var formData = {
                    identity: $('#email').val(),
                ...
                // Send the form data to the login controller using AJAX
                $.ajax({
                    url: actionurl,
                    type: 'post',
                    data: formData,
                    ...
                    error: function() {
                        // Display an error message
                        $('#error-message').text('Estamos passando por instabilidade. Por favor, tente novamente mais tarde.').show();
                    }
                });
            }
        });
