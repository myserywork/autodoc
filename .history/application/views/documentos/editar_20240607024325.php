            ...
            <form id="convenioForm">
                ...
                <div class="form-group mb-3">
                    ...
                    <select id="tipoConvenio" class="form-select">
                        ...
                        <option value="Nota Técnica" <?=((isset($documento) && $documento->tipo == "Nota Técnica") ? "selected" : "");?>>Nota Técnica</option>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <?php if(isset($documento)) { ?>
                        <a onclick="exportarSEI()" href="#" type="button" class="btn btn-info mt-3" >Exportar para o SEI</a>
