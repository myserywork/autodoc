...
function corrigir_acentuacao($texto) {
    // Remove BOM (Byte Order Mark) se existir
    $texto_sem_bom = preg_replace('/\x{FEFF}/u', '', $texto);
    
    // Substitui caracteres corrompidos por seus equivalentes corretos
    $map = [
        'Ã ' => 'à', 'Ã¡' => 'á', 'Ã¢' => 'â', 'Ã£' => 'ã', 'Ã¤' => 'ä', 
        ...
        'ÃŽ' => 'Î', 'Ã‘' => 'Ñ', 'Ã’' => 'Ò', 'Ã”' => 'Ô', 'Ã•' => 'Õ',
        'Ã–' => 'Ö', 'Ã™' => 'Ù', 'Ã›' => 'Û', 'Ãœ' => 'Ü', 'Ã' => 'Ï',
        'Ã' => 'Í', 'Ã‹' => 'Ë', 'Ã' => 'Í', 'ÃŠ' => 'Ê', 'ÃŒ' => 'Ì',
        'Ãƒ' => 'Ã', 'Ã‘' => 'Ñ', 'Ã‡' => 'Ç', 'Ã‡' => 'Ç', 'Ã„' => 'Ä',
        'Ã‹' => 'Ë', 'ÃŽ' => 'Î', 'ÃŠ' => 'Ê', 'ÃŠ' => 'Ê', 'Ã“' => 'Ó',
        'Ã“' => 'Ó', 'Ãœ' => 'Ü', 'Ãš' => 'Ú', 'Ãš' => 'Ú', 'ÃŠ' => 'Ê',
        'Ã‰' => 'É', 'Ãˆ' => 'È', 'Ã�' => 'Í', 'Ã’' => 'Ò', 'Ã”' => 'Ô',
        'Ã•' => 'Õ', 'Ã–' => 'Ö', 'Ã™' => 'Ù', 'Ãš' => 'Ú', 'Ã‹' => 'Ë'
    ];

    // Substitui os caracteres corrompidos no texto
    $texto_corrigido = strtr($texto_sem_bom, $map);
