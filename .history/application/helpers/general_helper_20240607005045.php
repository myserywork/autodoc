...
function corrigir_acentuacao($texto) {
    ...
    // Decodifica de UTF-8 para ISO-8859-1 para corrigir caracteres corrompidos
    $texto_decodificado = utf8_decode($texto_sem_bom);

    // Re-encode para UTF-8
    $texto_corrigido = utf8_encode($texto_decodificado);
