...
function corrigir_acentuacao($texto) {
    // Primeiro decodificar de UTF-8 para ISO-8859-1 para corrigir os caracteres corrompidos
    $texto_decodificado = utf8_decode($texto);
    
    // Em seguida, remover possíveis caracteres BOM
    $texto_corrigido = preg_replace('/\x{FEFF}/u', '', $texto_decodificado);
