...
class Automacoes extends CI_Controller {
    ...
    $editor_montar_url = parse($formPost['resultado'],"janelaEditor.location.href = 'controlador.php?acao=","'");


    dump($editor_montar_url);

    
     $url = 'https://sei.agro.gov.br/sei/controlador.php?acao=' + $editor_montar_url;

     echo $url;
     die();
  

    $editor = $this->simplebrowser->get($url);
