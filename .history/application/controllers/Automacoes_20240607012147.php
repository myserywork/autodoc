...
class Automacoes extends CI_Controller {
    ...
    public function index() {
      ...
      //  echo $processo;
       ...
       // echo ($processo_visualizar);
        ...
        $termo = array_search('Nota Técnica', array_column($lista, 'text'));
    ...
    $formPostData =  [
        'txaEditor_6190'=> 'HEADER',
        'txaEditor_6191'=>  mb_convert_encoding($documento->texto, 'HTML-ENTITIES', 'UTF-8'),
        'txaEditor_6192' => 'BODY',
        'txaEditor_6194' => 'FOOTER',
        'txaEditor_6195' =>  'FOOTER',
        'txaEditor_6196' =>  'FOOTER',
